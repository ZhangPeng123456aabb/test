...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class='your_position'>
			您现在的位置:&nbsp;
			<a href='#'>当当图书</a> &gt;&gt;
			<font style='color: #cc3300'><strong><s:property value="category_name"/></strong> </font>
		</div>
							...
							<li>
								<div>
									<div class=second_fenlei>
										&middot;<s:property value="category_name"/>&nbsp;(23)
									</div>
								</div>
							</li>
							<div class="clear"></div>
				...
				<div id="divRight" class="list_right">
					...
					<div id="book_list" class="list_r_title">
						<div id="divTopPageNavi" class="list_r_title_text3">
					        ...
					        <c:if test="${requestScope.page>1 }">
					   		    <div class='list_r_title_text3a'>
								<a name=link_page_next href="${pageContext.request.contextPath }/book1/b1_PageBySearchOneBook?page=${requestScope.page-1}&rows=${requestScope.rows}&cateId=${requestScope.category_id}"><img src='../images/page_up.gif' /></a>
							    </div>
					         </c:if>
					   
					        <c:forEach begin="1" end="${requestScope.totalPage }" varStatus="vs">
					       		<div class='list_r_title_text3a'>
									<a name=link_page_next href="${pageContext.request.contextPath }/book1/b1_PageBySearchOneBook?page=${vs.count }&rows=${requestScope.rows}&cateId=${requestScope.category_id}">${vs.count }</a>
							   </div>
					       </c:forEach>
					
					       <c:if test="${requestScope.page == requestScope.totalPage}">
						    	<div class='list_r_title_text3a'>
								  <a name=link_page_next href="#"><img src='../images/page_down.gif' /> </a>
							    </div> 
					       </c:if>
					        <c:if test="${requestScope.page < requestScope.totalPage}">
							       	<div class='list_r_title_text3a'>
									<a name=link_page_next href="${pageContext.request.contextPath }/book1/b1_PageBySearchOneBook?page=${requestScope.page+1}&rows=${requestScope.rows}&cateId=${requestScope.category_id}"><img src='../images/page_down.gif' /> </a>
								    </div>
				        	</c:if>
							</div>
